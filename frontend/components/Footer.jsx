...
import { List, ListItem, Box, SvgIcon, IconButton } from '@mui/material';
	...
	return (
		<>
			...
			<Grid container spacing={1} sx={bottomStyles}>
				...
				<ListItem sx={socialStyles}>
					<Link sx={{ display: 'flex', justifyContent: 'center'  }}  href="https://github.com/ergopad" aria-label="Github" title="Github" target="_blank">
						<SvgIcon sx={{ width: '32px', height: '32px' }} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
